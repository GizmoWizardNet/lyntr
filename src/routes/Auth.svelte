	...
	<main>
		...
		<div class="actions">
			<button class="oauth discord" onclick={handleDiscordLogin} disabled={loadingDiscord || loadingGoogle}>
				...
				<span class="label">{loadingDiscord ? 'Redirecting...' : 'Use Discord like a CHAD'}</span>
			</button>
			...
			<button class="oauth google" onclick={handleGoogleLogin} disabled={loadingDiscord || loadingGoogle}>
				...
				<span class="label">{loadingGoogle ? 'Redirecting...' : 'Use Google like a normie'}</span>
			</button>
		</div>
		...
		<nav class="foot-links">
			...
			<span class="sep" aria-hidden="true">·</span>
			<a href="https://github.com/GizmoWizardNet/lyntr">Repository</a>
		</nav>
	</main>
</div>
