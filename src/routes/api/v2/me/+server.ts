...
// PATCH /api/v2/me — text-only profile customization (bio, display name,
// name color). Matches the app's own validation rules. Avatar/banner/
// profile-song uploads still aren't available over the API — v2 added
// multipart support to lynt/comment creation specifically (POST
// /v2/lynts, POST /v2/lynts/:id/comments), not to every endpoint.
