...
<Card class="mx-auto w-full max-w-3xl">
	<CardHeader>
		...
		<CardDescription>Effective Date: June 16, 2025</CardDescription>
	</CardHeader>
	<CardContent>
		<Accordion>
			...
			<AccordionItem value="item-2">
				...
				<AccordionContent>
					<p>
						...
						users, liking and sharing content, reposting, earning badges, and customizing profiles.
					</p>
				</AccordionContent>
			</AccordionItem>
			...
			<AccordionItem value="item-6">
				...
				<AccordionContent>
					<p>
						...
						created and operated by GizmoWizard. While we haven't registered formal intellectual
						property rights, we kindly ask users to respect our work. Users agree not to copy,
						modify, or distribute any part of the service without explicit permission from GizmoWizard.
					</p>
				</AccordionContent>
			</AccordionItem>
			...
			<AccordionItem value="item-7">
				...
				<AccordionContent>
					<p>
						...
						<strong>clearly and prominently disclose</strong> that you are not affiliated with GizmoWizard
			...
			<AccordionItem value="item-10">
				...
				<AccordionContent>
					<p>
						In no event shall GizmoWizard, its directors, employees, partners, agents, suppliers, or
			...
			<AccordionItem value="item-12">
				...
				<AccordionContent>
					<p>
						...
						dev@gizmowizard.tech
					</p>
				</AccordionContent>
			</AccordionItem>
		</Accordion>
				<p class="mt-4 text-xs text-muted-foreground border-t border-border pt-4">
				Lyntr is based on the original Lyntr project by FaceDev and has been modified extensively by GizmoWizard. Original project: <a href="https://github.com/face-hh/lyntr" target="_blank" rel="noopener noreferrer" class="underline">github.com/face-hh/lyntr</a>
			</p>
	</CardContent>
</Card>
